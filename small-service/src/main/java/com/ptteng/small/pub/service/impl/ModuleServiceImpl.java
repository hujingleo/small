...
public class ModuleServiceImpl extends BaseDaoServiceImpl implements ModuleService {
     ...
     */
    @Override
    public List<Long> getModuleIdsByType(String type, Integer start, Integer limit)
        ...
        try {
            idList = dao.getIdList("getModuleIdsByType", new Object[] { type }, start, limit, false);
    ...
    public Long getModuleIdByUrlAndType(String url, String type) throws ServiceException, ServiceDaoException {
        ...
        try {
            ...
            log.error(" get id  wrong by url,type  : " + url + " , " + type);
            log.error(e);
            e.printStackTrace();
            throw new ServiceDaoException(e);
        }
        if (log.isInfoEnabled()) {
            log.info(" get ids success : " + (id == null ? "null" : id));
        }
        return id;
