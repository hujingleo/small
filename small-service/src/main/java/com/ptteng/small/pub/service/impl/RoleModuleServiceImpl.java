...
public class RoleModuleServiceImpl extends BaseDaoServiceImpl implements RoleModuleService {
     ...
     */
    @Override
    public List<Long> getRoleModuleIdsByRid(Long rid, Integer start, Integer limit)
     ...
     */
    @Override
    public List<Long> getRoleModuleIdsByMid(Long mid, Integer start, Integer limit)
            throws ServiceException, ServiceDaoException {
